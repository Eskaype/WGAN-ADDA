...
class multi_source:
    ...
    def validation(self, args, timestampLaunch, epoch):
        ...
        if iou_cup > self.best_metrics['cup'] or iou_disc > self.best_metrics['disc'] or delta_cdr < self.best_metrics['delta_cdr'] :
            ...
            self.num_epochs_last_save+=1
            if self.num_epochs_last_save > 20:
...
def main():
    ...
    parser.add_argument('--epochs', type=int, default=400, metavar='N',
                        help='number of epochs to train (default: auto)')
    parser.add_argument('--meta_update_step', type=int, default=2, metavar='N',
                        help='number of epochs to train (default: auto)')
    ...
    parser.add_argument('--output-dir', type=str, default='pretrained', help='output path')
